 ...
 * - Pumps has four different methods of estimating FLA, with the four methods corresponding to the four efficiency choices.
 ...
 *  - For Average Efficiency selection, it averages the FLA for Energy Efficient and Standard Efficiency choices.  The average of the two values listed above is 227.2 amps, which is what Pumps returns.
...
//        const double effValEE = motorEfficiency.calculateThermalResistance(1);
