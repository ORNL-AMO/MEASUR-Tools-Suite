...
double SteamModelRunner::handleSteamBalanceException(const SteamBalanceException& e, const int iterationCount,
    ...
    int iterationCount_          = iterationCount;
    iterationCount_              = iterationCount_; // keep this or fix unused variable
    double initialMassFlow_      = initialMassFlow;
    initialMassFlow_             = initialMassFlow_; // keep this or fix unused variable
    const std::string methodName = std::string("SteamModelRunner::") + std::string(__func__) + ": ";
