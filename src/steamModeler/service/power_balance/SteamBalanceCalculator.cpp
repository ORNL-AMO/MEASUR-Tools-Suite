...
double SteamBalanceCalculator::calc(
    ...
    const double steamUse = steamUseCalculator.calc(headerCountInput, highPressureHeaderInput, lowPressureHeaderInput,
                                                    mediumPressureHeaderInput, deaeratorInletSteamMassFlow,
                                                    condensingTurbineInput, condensingTurbine);

    const double steamProduction =
        steamProductionCalculator.calc(headerCountInput, mediumPressureHeaderInput, lowPressureHeaderInput, boilerInput,
                                       blowdownFlashTank, boiler, highPressureHeaderCalculationsDomain,
