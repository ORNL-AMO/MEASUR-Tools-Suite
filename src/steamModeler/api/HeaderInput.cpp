...
double HeaderWithPressure::getPressure() const { return pressure; }

double HeaderWithPressure::getProcessSteamUsage() const { return processSteamUsage; }

double HeaderWithPressure::getCondensationRecoveryRate() const { return condensationRecoveryRate; }

double HeaderWithPressure::getHeatLoss() const { return heatLoss; }

bool HeaderWithPressure::isFlashCondensate() const { return flashCondensate; }
...
std::ostream& operator<<(std::ostream& stream, const HeaderWithHighestPressure& header) {
    return stream << "HeaderWithHighestPressure[" << "pressure=" << header.pressure
                  << ", processSteamUsage=" << header.processSteamUsage
                  << ", condensationRecoveryRate=" << header.condensationRecoveryRate
                  << ", heatLoss=" << header.heatLoss << ", flashCondensate=" << header.flashCondensate
                  << ", condensateReturnTemperature=" << header.condensateReturnTemperature << "]";
}

double HeaderWithHighestPressure::getCondensateReturnTemperature() const { return condensateReturnTemperature; }
...
std::ostream& operator<<(std::ostream& stream, const HeaderNotHighestPressure& header) {
    return stream << "HeaderNotHighestPressure[" << "pressure=" << header.pressure
                  << ", processSteamUsage=" << header.processSteamUsage
                  << ", condensationRecoveryRate=" << header.condensationRecoveryRate
                  << ", heatLoss=" << header.heatLoss << ", flashCondensate=" << header.flashCondensate
...
bool HeaderNotHighestPressure::isDesuperheatSteamIntoNextHighest() const { return desuperheatSteamIntoNextHighest; }

double HeaderNotHighestPressure::getDesuperheatSteamTemperature() const { return desuperheatSteamTemperature; }
...
std::ostream& operator<<(std::ostream& stream, const HeaderInput& headerInput) {
    return stream << "HeaderInput[" << "highPressureHeader=" << headerInput.highPressureHeader
...
int HeaderInput::getHeaderCount() const {
    ...
    if (mediumPressureHeader != nullptr)
        headerCount++;
...
HeaderWithHighestPressure HeaderInput::getHighPressureHeader() const { return highPressureHeader; }

std::shared_ptr<HeaderNotHighestPressure> HeaderInput::getLowPressureHeader() const { return lowPressureHeader; }

std::shared_ptr<HeaderNotHighestPressure> HeaderInput::getMediumPressureHeader() const { return mediumPressureHeader; }
