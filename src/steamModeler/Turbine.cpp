...
void Turbine::solveForOutletProperties()
{
	...
	auto const outletSpecificEnthalpy = inletSpecificEnthalpy - isentropicEfficiency * (inletSpecificEnthalpy - idealOutletSpecificEnthalpy);
...
void Turbine::solveForIsentropicEfficiency()
{
	...
	isentropicEfficiency = (inletSpecificEnthalpy - outletProperties.specificEnthalpy) / (inletSpecificEnthalpy - idealOutletSpecificEnthalpy);
