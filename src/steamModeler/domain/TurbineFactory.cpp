...
Turbine TurbineFactory::make(const SteamSystemModelerTool::FluidProperties& headerProperties,
    ...
    return {solveFor,           inletPressure,        inletQuantity,       inletQuantityValue,
            turbineProperty,    isentropicEfficiency, generatorEfficiency, massFlowOrPowerOut,
            outletSteamPressure};
}
...
Turbine TurbineFactory::make(const SteamSystemModelerTool::FluidProperties& headerProperties,
    ...
    const Turbine::TurbineProperty turbineProperty = convertCondensingTurbineOperationToTurbineProperty(operationType);
