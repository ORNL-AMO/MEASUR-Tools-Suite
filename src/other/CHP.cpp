...
void CHP::calculate()
{
	...
	// CHP::CostInfoOutput {annualOperationSavings, totalInstalledCostsPayback, simplePayback, fuelCosts, thermalCredit, incrementalOandMDollarsKwH, totalOperatingCostsToGenerate};
	this->costInfo = {annualOperationSavings, totalInstalledCostsPayback, simplePayback, fuelCosts, thermalCredit, incrementalOandMDollarsKwH, totalOperatingCostsToGenerate};
