...
double OpeningLosses::getHeatLoss() {
    ...
    const double hlRad = emissivity * stephenBoltzman *
...
double OpeningLosses::calculateViewFactor(const double thickness, const double diameter) {
    ...
    if (thicknessRatio >= 6)
        return viewFactorEquations[1](6);
    if (thicknessRatio < 0.1)
        return viewFactorEquations[0](0.1) * thicknessRatio / 0.1;
    if (thicknessRatio < 1)
        return viewFactorEquations[0](thicknessRatio);
...
double OpeningLosses::calculateViewFactor(const double thickness, const double length, const double height) {
    ...
    if (thicknessRatio >= 6) {
        if (lateralDimensionRatio >= 1 && lateralDimensionRatio < 2) {
            return viewFactorEquations[3](6) +
                   (viewFactorEquations[5](6) - viewFactorEquations[3](6)) * (lateralDimensionRatio - 1);
        }
        if (lateralDimensionRatio >= 2 && lateralDimensionRatio < 10) {
            return viewFactorEquations[5](6) +
                   (viewFactorEquations[7](6) - viewFactorEquations[5](6)) * (lateralDimensionRatio - 2) / 8;
        }
        ...
        if (lateralDimensionRatio >= 1 && lateralDimensionRatio < 2) {
            return viewFactorEquations[2](tr) +
                   (viewFactorEquations[4](tr) - viewFactorEquations[2](tr)) * (lateralDimensionRatio - 1);
        }
        if (lateralDimensionRatio >= 2 && lateralDimensionRatio < 10) {
            return viewFactorEquations[4](tr) +
                   (viewFactorEquations[6](tr) - viewFactorEquations[4](tr)) * (lateralDimensionRatio - 2) / 8;
        }
        return viewFactorEquations[6](tr) * thicknessRatio / tr;
    }
    else {
        if (lateralDimensionRatio >= 1 && lateralDimensionRatio < 2) {
            return viewFactorEquations[3](thicknessRatio) +
                   (viewFactorEquations[5](thicknessRatio) - viewFactorEquations[3](thicknessRatio)) *
                       (lateralDimensionRatio - 1);
        }
        if (lateralDimensionRatio >= 2 && lateralDimensionRatio < 10) {
            return viewFactorEquations[5](thicknessRatio) +
                   (viewFactorEquations[7](thicknessRatio) - viewFactorEquations[5](thicknessRatio)) *
                       (lateralDimensionRatio - 2) / 8;
        }
