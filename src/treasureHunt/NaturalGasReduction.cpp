...
NaturalGasReduction::Output NaturalGasReduction::calculate() {
    ...
    for (auto& naturalGasReductionInput : naturalGasReductionInputVec) {
        ...
        // air mass flow method
            ...
            tmpHeatFlow = (1.08 * tmpAirFlowRate *
                           (airMassFlowData.getOutletTemperature() - airMassFlowData.getInletTemperature())) /
                          1000000;
            tmpTotalFlow = tmpAirFlowRate * naturalGasReductionInput.getUnits();

            tmpEnergyUse =
                (tmpHeatFlow * naturalGasReductionInput.getOperatingHours() * naturalGasReductionInput.getUnits()) /
                airMassFlowData.getSystemEfficiency();
            tmpEnergyCost = tmpEnergyUse * naturalGasReductionInput.getFuelCost();
        }
        // water mass flow method
            ...
            tmpHeatFlow                         = (500 * waterMassFlowData.getWaterFlow() *
                           (waterMassFlowData.getOutletTemperature() - waterMassFlowData.getInletTemperature())) /
                          1000000;
            tmpTotalFlow = waterMassFlowData.getWaterFlow() * naturalGasReductionInput.getUnits();
            tmpEnergyUse =
                (tmpHeatFlow * naturalGasReductionInput.getOperatingHours() * naturalGasReductionInput.getUnits()) /
                waterMassFlowData.getSystemEfficiency();
            tmpEnergyCost = tmpEnergyUse * naturalGasReductionInput.getFuelCost();
        }
...
void FlowMeterMethodData::setFlowRate(const double flowRate) { this->flowRate = flowRate; }

void NaturalGasOtherMethodData::setConsumption(const double consumption) { this->consumption = consumption; }

void AirMassFlowMeasuredData::setAreaOfDuct(const double areaOfDuct) { this->areaOfDuct = areaOfDuct; }

void AirMassFlowMeasuredData::setAirVelocity(const double airVelocity) { this->airVelocity = airVelocity; }

void AirMassFlowNameplateData::setAirFlow(const double airFlow) { this->airFlow = airFlow; }

void AirMassFlowData::setIsNameplate(const bool isNameplate) { this->isNameplate = isNameplate; }
...
void AirMassFlowData::setInletTemperature(const double inletTemperature) { this->inletTemperature = inletTemperature; }

void AirMassFlowData::setOutletTemperature(const double outletTemperature) {
    this->outletTemperature = outletTemperature;
}

void AirMassFlowData::setSystemEfficiency(const double systemEfficiency) { this->systemEfficiency = systemEfficiency; }

void WaterMassFlowData::setWaterFlow(const double waterFlow) { this->waterFlow = waterFlow; }
...
void NaturalGasReduction::setNaturalGasReductionInputVec(
