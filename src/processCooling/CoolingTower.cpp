...
CoolingTowerMakeupWaterCalculator::Output CoolingTowerMakeupWaterCalculator::calculate() {
    auto const calculateWaterConsumption = [](const CoolingTowerOperatingConditionsData& operatingConditionsData,
        ...
        evaporationLoss = operatingConditionsData.getLossCorrectionFactor() * 0.01 *
                          operatingConditionsData.getCoolingLoad() * 1000000 /
                          (500 * 10); // 0.01 = evaporation loss for ideal case
        ...
        waterConsumption =
            (evaporationLoss + driftLoss + blowDown) * operatingConditionsData.getOperationalHours() * 60;
    ...
    double wcModification =
        calculateWaterConsumption(this->operatingConditionsData, this->waterConservationModificationData);
...
void CoolingTowerOperatingConditionsData::setFlowRate(double flowRate) { this->flowRate = flowRate; }
void CoolingTowerOperatingConditionsData::setCoolingLoad(double coolingLoad) { this->coolingLoad = coolingLoad; }
...
void CoolingTowerMakeupWaterCalculator::setOperatingConditionsData(
    CoolingTowerOperatingConditionsData operatingConditionsData) {
    this->operatingConditionsData = operatingConditionsData;
}
void CoolingTowerMakeupWaterCalculator::setWaterConservationBaselineData(
...
void CoolingTowerMakeupWaterCalculator::setWaterConservationModificationData(
