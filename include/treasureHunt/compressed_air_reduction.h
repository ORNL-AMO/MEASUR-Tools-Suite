 ...
 * one standard cubic foot per minute of compressed air flow. It is used to convert the calculated
 * air consumption into equivalent electrical energy use.
 * @see compressed_air_reduction_electricity_formula
 */
struct CompressorElectricityData {
    double compressor_control_adjustment = 0.0; ///< Compressor control adjustment factor (dimensionless)
