...
class CompressedAirPressureReductionInput {
  public:
     ...
     */
    CompressedAirPressureReductionInput(const bool isBaseline, const int hoursPerYear, const double electricityCost,
                                        const double compressorPower, const double pressure,
                                        const double proposedPressure, const double atmosphericPressure,
...
class CompressedAirPressureReduction {
  public:
    struct Output {
        Output(double energyUse, double energyCost) : energyUse(energyUse), energyCost(energyCost) {}
    ...
    CompressedAirPressureReduction(
        ...
        : compressedAirPressureReductionInputVec(compressedAirPressureReductionInputVec) {}
    ...
    void setCompressedAirPressureReductionInputVec(
        std::vector<CompressedAirPressureReductionInput>& compressedAirPressureReductionInputVec);
