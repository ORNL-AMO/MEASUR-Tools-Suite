...
class InsulatedTankOutput {
  public:
    InsulatedTankOutput();
    InsulatedTankOutput(double heatLoss, double annualHeatLoss)
        : _heatLoss(heatLoss), _annualHeatLoss(annualHeatLoss) {}

    double getHeatLoss() { return this->_heatLoss; }

    double getAnnualHeatLoss() { return this->_annualHeatLoss; }

    void setHeatLoss(double heatLoss) { this->_heatLoss = heatLoss; }
...
class InsulatedTankInput {
  public:
    InsulatedTankInput(int operatingHours, double tankHeight, double tankDiameter, double tankThickness,
                       double tankEmissivity, double tankConductivity, double tankTemperature,
                       double ambientTemperature, double systemEfficiency, double insulationThickness,
                       double insulationConductivity, double jacketEmissivity, double surfaceTemperature)
        : _operatingHours(operatingHours), _tankHeight(tankHeight), _tankDiameter(tankDiameter),
          _tankThickness(tankThickness), _tankEmissivity(tankEmissivity), _tankConductivity(tankConductivity),
          _tankTemperature(tankTemperature), _ambientTemperature(ambientTemperature),
          _systemEfficiency(systemEfficiency), _insulationThickness(insulationThickness),
          _insulationConductivity(insulationConductivity), _jacketEmissivity(jacketEmissivity),
          _surfaceTemperature(surfaceTemperature) {}

    int getOperatingHours() { return this->_operatingHours; }

    double getTankHeight() { return this->_tankHeight; }

    double getTankDiameter() { return this->_tankDiameter; }

    double getTankThickness() { return this->_tankThickness; }

    double getTankEmissivity() { return this->_tankEmissivity; }

    double getTankConductivity() { return this->_tankConductivity; }

    double getTankTemperature() { return this->_tankTemperature; }
    ...
    double getInsulationConductivity() { return this->_insulationConductivity; }

    double getJacketEmissivity() { return this->_jacketEmissivity; }

    double getSurfaceTemperature() { return this->_surfaceTemperature; }
