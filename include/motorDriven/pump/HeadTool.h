 ...
 * Used to calculateReynoldsNumber velocity and velocity head so those values can be used in the HeadToolSuctionTank class or HeadTool class to calculateThermalResistance all of the values in the returned map.
 */
class HeadToolBase
{
  public:
