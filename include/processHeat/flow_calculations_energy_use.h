...
FlowCalculationsEnergyUseResults flowCalculationsEnergyUse(double specific_gravity, double orifice_diameter,
                                                                    double inside_pipe_diameter,
                                                                    double discharge_coefficient, double gas_heating_value,
                                                                    double gas_temperature, double gas_pressure,
                                                                    double orifice_pressure_drop, double operating_time);
} // namespace flow_calculations_energy_use
