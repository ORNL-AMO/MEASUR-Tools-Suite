 ...
 * Used to help calculateThermalResistance potential fuel savings by increasing the efficiency of the furnace.
 */
class EfficiencyImprovement {
  public:
     ...
     *
     * */
    EfficiencyImprovement(double currentFlueGasOxygen, double newFlueGasOxygen, double currentFlueGasTemp,
                          double newFlueGasTemp, double currentCombustionAirTemp, double newCombustionAirTemp,
                          double currentEnergyInput)
        : currentFlueGasOxygen_(currentFlueGasOxygen), newFlueGasOxygen_(newFlueGasOxygen),
          currentFlueGasTemp_(currentFlueGasTemp), newFlueGasTemp_(newFlueGasTemp),
          currentCombustionAirTemp_(currentCombustionAirTemp), newCombustionAirTemp_(newCombustionAirTemp),
     ...
     */
    double getCurrentFlueGasOxygen() const { return currentFlueGasOxygen_; }
     ...
     *
     */
    void setCurrentFlueGasOxygen(double currentFlueGasOxygen) { currentFlueGasOxygen_ = currentFlueGasOxygen; }
     ...
     */
    double getNewFlueGasOxygen() const { return newFlueGasOxygen_; }
     ...
     *
     */
    void setNewFlueGasOxygen(double newFlueGasOxygen) { newFlueGasOxygen_ = newFlueGasOxygen; }
     ...
     */
    double getCurrentFlueGasTemp() const { return currentFlueGasTemp_; }
     ...
     *
     */
    void setCurrentFlueGasTemp(double currentFlueGasTemp) { currentFlueGasTemp_ = currentFlueGasTemp; }
     ...
     */
    double getNewFlueGasTemp() const { return newFlueGasTemp_; }
     ...
     *
     */
    void setNewFlueGasTemp(double newFlueGasTemp) { newFlueGasTemp_ = newFlueGasTemp; }
     ...
     */
    double getCurrentCombustionAirTemp() const { return currentCombustionAirTemp_; }
     ...
     */
    double getNewCombustionAirTemp() const { return newCombustionAirTemp_; }
     ...
     *
     */
    void setNewCombustionAirTemp(double newCombustionAirTemp) { newCombustionAirTemp_ = newCombustionAirTemp; }
     ...
     */
    double getCurrentEnergyInput() const { return currentEnergyInput_; }
     ...
     *
     */
    void setCurrentEnergyInput(double currentEnergyInput) { currentEnergyInput_ = currentEnergyInput; }
     ...
     */
    double getCurrentFuelSavings() { return currentFuelSavings_; };
