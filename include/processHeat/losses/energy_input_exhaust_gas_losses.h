...
class EnergyInputExhaustGasLosses {
  public:
    /**
     * Constructor for the energy input - exhaust gas losses - Will calculateThermalResistance effThermal given input
     * parameters and calculateThermalResistance heatDelivered and exhaustGasLosses
     ...
     * @param totalHeatInput optional double, total heat input from all sources of heat supplied in Btu/hr, if this is
     * zero, available heat will be 100%
     * */
