 ...
 * through the flue.
 *
 * @deprecated Do not use this class getHeatLoss function, use enhanced GasComposition's getProcessHeatProperties
 * function
 */
class GasFlueGasMaterial {
  public:
     ...
     * @param excessAirPercentage double, Percent Excess Air, expressed in normal percentage (i.e. 9% as 9 instead of
     * 0.09)
