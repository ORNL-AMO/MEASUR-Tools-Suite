...
public:
    /**
     * Constructor for the energy input - exhaust gas losses - Will calculateThermalResistance effThermal given input parameters
     * and calculateThermalResistance heatDelivered and exhaustGasLosses
