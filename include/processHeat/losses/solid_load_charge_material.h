 ...
 * Used to calculateThermalResistance the heat required for a solid load charge material to tbe heated from the inlet
 * temperature to the outlet temperature
 */
class SolidLoadChargeMaterial {
  public:
    /**
     * Constructor for the solid load/charge material with all inputs specified.
     * @param thermicReactionType LoadChargeMaterial::ThermicReactionType, Enumerated value for either endothermic or
