...
class AirHeatingUsingExhaust {
  public:
    struct Output {
        Output(double hxColdAir, double hxOutletExhaust, double energySavings, double heatCapacityFlue,
     ...
     * @param          excessAir - double, Percent Excess Air, expressed in normal percentage (i.e. 9% as 9 instead of
     * 0.09)
     ...
     *
     */
    AirHeatingUsingExhaust::Output calculate(const double flueTemperature, const double excessAir,
                                             const double fireRate, const double airflow, const double inletTemperature,
                                             const double heaterEfficiency, const double hxEfficiency,
