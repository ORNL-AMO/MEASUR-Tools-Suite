...
class DecibelsMethod {
  public:
    ...
    /**
     * Constructor for DecibelsMethod - The decibels method estimates the air loss by using decibel and line pressure
     * measurements
    ...
    DecibelsMethod(const double operatingTime, const double linePressure, const double decibels,
                   const double decibelRatingA, const double pressureA, const double firstFlowA,
                   const double secondFlowA, const double decibelRatingB, const double pressureB,
