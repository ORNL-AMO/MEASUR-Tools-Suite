 ...
 */
	 ...
	 */
	double absolutePressure = 0, saturatedHumidity = 0, saturationDegree = 0, humidityRatio = 0,
    specificVolume = 0, enthalpy = 0, dewPoint = 0, relativeHumidity = 0, saturationPressure = 0;
