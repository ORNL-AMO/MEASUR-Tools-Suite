 ...
 * Used to calculateThermalResistance the required water and steam flows for a required feedwater mass flow.
 */
class Deaerator {
  public:
    /**
     ...
     * @param waterQuantityType SteamProperties::ThermodynamicQuantity, type of quantity (either temperature in K,
     enthalpy in kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     * @param waterQuantityValue double, value of the quantity (either temperature in K, enthalpy in kJ/kg, entropy in
     kJ/kg/K, or quality - unitless)
     * @param steamPressure double, pressure of steam in MPa
     * @param steamQuantityType SteamProperties::ThermodynamicQuantity, type of quantity (either temperature in K,
     enthalpy in kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     * @param steamQuantityValue double, value of the quantity (either temperature in K, enthalpy in kJ/kg, entropy in
     kJ/kg/K, or quality - unitless)

     *
     * */
    Deaerator(double deaeratorPressure, double ventRate, double feedwaterMassFlow, double waterPressure,
              SteamProperties::ThermodynamicQuantity waterQuantityType, double waterQuantityValue, double steamPressure,
     ...
     * @return SteamProperties::ThermodynamicQuantity, type of quantity for water (either temperature in K, enthalpy in
     * kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     */
     ...
     * @return double, value of quantity for steam (either temperature in K, enthalpy in kJ/kg, entropy in kJ/kg/K, or
     * quality - unitless)
     */
     ...
     * @return SteamProperties::ThermodynamicQuantity, type of quantity for steam (either temperature in K, enthalpy in
     * kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     */
     ...
     * @param waterQuantityValue double, value of quantity for water (either temperature in K, enthalpy in kJ/kg,
     ...
     * @param steamQuantityValue double, value of quantity for steam (either temperature in K, enthalpy in kJ/kg,
     * entropy in kJ/kg/K, or quality - unitless)
     */
     ...
     * @param waterQuantityType SteamProperties::ThermodynamicQuantity, type of quantity for water (either temperature
     * in K, enthalpy in kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     */
    void setWaterQuantityType(SteamProperties::ThermodynamicQuantity quantity);

    /**
     * Sets the quantity type for steam
     * @param steamQuantityType SteamProperties::ThermodynamicQuantity, type of quantity for steam (either temperature
     * in K, enthalpy in kJ/kg, entropy in kJ/kg/K, or quality - unitless)
     */
