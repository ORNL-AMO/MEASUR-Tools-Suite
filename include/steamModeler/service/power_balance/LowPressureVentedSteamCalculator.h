...
class LowPressureVentedSteamCalculator {
  ...
  private:
    ...
    const MakeupWaterAndCondensateHeaderCalculator makeupWaterAndCondensateHeaderCalculator =
    ...
    double calcLowPressureVentedSteam(const std::shared_ptr<HeaderNotHighestPressure>& lowPressureHeaderInput,
