 ...
 * Used to calculateThermalResistance the heat energy loss and outlet steam properties
 */
class FlashTank {
  public:
    /**
  ...
  private:
    ...
    SteamSystemModelerTool::FluidProperties inletWaterProperties, outletLiquidSaturatedProperties,
