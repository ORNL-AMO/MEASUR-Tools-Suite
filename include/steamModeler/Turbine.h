 ...
 * Used to calculateThermalResistance turbine properties
 *
 *
 */
class Turbine {
  public:
     ...
     * @param inletQuantity, type of quantity for water (either temperature in K, enthalpy in kJ/kg, entropy in kJ/kg/K,
     * or quality - unitless)
     * @param inletQuantityValue double, Thermodynamic Property of the Inlet used for calculations- Temperature (K),
     * Enthalpy (kJ/kg), Entropy (kJ/kg-K), or Quality (unitless)
     ...
     * @param massFlowOrPowerOut double, known turbine property: mass flow rate (kg/hr) or power output (kW)
     * @param outletSteamPressure double, outlet pressure of the steam in MPa
     * @param outletQuantity, type of quantity for water (either temperature in K, enthalpy in kJ/kg, entropy in
     * kJ/kg/K, or quality - unitless)
     * @param outletQuantityValue double, Thermodynamic Property of the outlet used for calculations- Temperature (K),
     * Enthalpy (kJ/kg), Entropy (kJ/kg-K), or Quality (unitless)
     *
     * */
    Turbine(Solve solveFor, double inletPressure, SteamProperties::ThermodynamicQuantity inletQuantity,
     ...
     *
     * @return double, Thermodynamic Property of the Inlet used for calculations- Temperature (K), Enthalpy (kJ/kg),
     * Entropy (kJ/kg-K), or Quality (unitless)
     */
    double getInletQuantityValue() const { return inletQuantityValue; }
    /**
     * Gets the Outlet Quantity Value
     *
     * @return double, Thermodynamic Property of the outlet used for calculations- Temperature (K), Enthalpy (kJ/kg),
     * Entropy (kJ/kg-K), or Quality (unitless)
     */
     ...
     *
     * @param inletQuantity, inlet type of quantity for water (either temperature in K, enthalpy in kJ/kg, entropy in
     * kJ/kg/K, or quality - unitless)
     */
     ...
     *
     * @param outletQuantity, outlet type of quantity for water (either temperature in K, enthalpy in kJ/kg, entropy in
     * kJ/kg/K, or quality - unitless)
     */
     ...
     *
     * @param outletQuantityValue double, Thermodynamic Property of the Inlet used for calculations- Temperature (K),
     * Enthalpy (kJ/kg), Entropy (kJ/kg-K), or Quality (unitless)
     */
