...
class HeaderFactory {
  public:
    ...
    const Header
    make(const int headerCountInput, const double headerPressure,
         const std::shared_ptr<FlashTank>&                              highPressureCondensateFlashTank,
