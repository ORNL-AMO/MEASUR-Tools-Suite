 ...
 */
export declare class HeaderWithHighestPressure {
    /**
     * @param pressure double, header pressure, units MPa
     * @param processSteamUsage double, process steam usage, units kg/hr
     * @param condensationRecoveryRate double, condensation recovery rate (%)
 ...
 */
export declare class HeaderNotHighestPressure {
    /**
     * @param pressure double, header pressure, units MPa
     * @param processSteamUsage double, process steam usage, units kg/hr
     * @param condensationRecoveryRate double, condensation recovery rate (%)
 ...
 */
export interface MakeupWaterVolumeFlowCalculationsDomain {
 ...
 */
export interface ReturnCondensateCalculationsDomain {
 ...
 */
export interface LowPressureFlashedSteamIntoHeaderCalculatorDomain {
 ...
 */
export interface LowPressureVentedSteamCalculationsDomain {
 ...
 */
export interface EnergyAndCostCalculationsDomain {
 ...
 */
export interface ProcessSteamUsageCalculationsDomain {
 ...
 */
export interface PowerBalanceCheckerCalculationsDomain {
 ...
 */
export interface MakeupWaterAndCondensateHeaderCalculationsDomain {
 ...
 */
export interface LowPressureHeaderCalculationsDomain {
 ...
 */
export interface MediumPressureHeaderCalculationsDomain {
 ...
 */
export interface HighPressureHeaderCalculationsDomain {
 ...
 */
export interface SteamModelerOutput {
    /** Boiler output */
    boiler: Boiler;
...
export type SsmtModelerModule = {
    ...
    PowerBalanceCheckerCalculationsDomain: PowerBalanceCheckerCalculationsDomain;
    MakeupWaterAndCondensateHeaderCalculationsDomain: MakeupWaterAndCondensateHeaderCalculationsDomain;
    LowPressureHeaderCalculationsDomain: LowPressureHeaderCalculationsDomain;
    MediumPressureHeaderCalculationsDomain: MediumPressureHeaderCalculationsDomain;
    HighPressureHeaderCalculationsDomain: HighPressureHeaderCalculationsDomain;
    SteamModelerOutput: SteamModelerOutput;
