#include "compressedAir/CompressedAir.h"
#include <vector>
...
EMSCRIPTEN_BINDINGS(airSystemCapacity)
{
    class_<Compressor::PipeData>("PipeData")
        ...
        .property("eight", &Compressor::PipeData::eight)
        .property("ten", &Compressor::PipeData::ten)
        .property("twelve", &Compressor::PipeData::twelve)
        .property("fourteen", &Compressor::PipeData::fourteen)
        .property("sixteen", &Compressor::PipeData::sixteen)
        .property("eighteen", &Compressor::PipeData::eighteen)
        .property("twenty", &Compressor::PipeData::twenty)
        .property("twentyFour", &Compressor::PipeData::twentyFour);
