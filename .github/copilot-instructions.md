...
- Finally, update the documentation in the docs/dox-content directory. Organize the content logically following the pattern that has already be established.
