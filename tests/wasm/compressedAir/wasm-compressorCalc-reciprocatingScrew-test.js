...
function compId737() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(62.69), "compressor 737: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(137.41), "compressor 737: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(8.73), "compressor 737: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(138.1), "compressor 737: kW_Calc 2");
    //POWER CALCULATED SLIGHTLY DIFFERENT FOR %POWER CALC VS %CAPACITY
    ...
    testNumberValue(rnd(results.PerkW), rnd(96.85), "compressor 737: PerkW 3");
    testNumberValue(rnd(results.kW_Calc), rnd(212.3), "compressor 737: kW_Calc 3");
    ...
    //    t.equal(rnd(results.powerCalculated), rnd(212.04));
    testNumberValue(rnd(results.C_Per), rnd(90.57), "compressor 737: C_Per 3");
    testNumberValue(rnd(results.kW_Calc), rnd(211.97), "compressor 737: kW_Calc 3");
}
...
function compId701() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(71.99), "compressor 701: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(119.86), "compressor 701: kW_Calc 1");
    ...
    // t.equal(rnd(results.powerCalculated), rnd(119.9));
    testNumberValue(rnd(results.C_Per), rnd(20.06), "compressor 701: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(119.9), "compressor 701: kW_Calc 2");
}
...
function compId728() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(57.02), "compressor 728: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(124.98), "compressor 728: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(9.6), "compressor 728: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(124.94), "compressor 728: kW_Calc 2");
    ...
    testNumberValue(rnd(results.PerkW), rnd(93.4), "compressor 728: PerkW 3");
    testNumberValue(rnd(results.kW_Calc), rnd(204.72), "compressor 728: kW_Calc 3");
    ...
    testNumberValue(rnd(results.C_Per), rnd(92.38), "compressor 728: C_Per 4");
    testNumberValue(rnd(results.kW_Calc), rnd(205.39), "compressor 728: kW_Calc 4");
}
...
function compId629LoadUnload() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(70.72), "compressor 629 LoadUnload: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(60.4), "compressor 629 LoadUnload: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(9.92), "compressor 629 LoadUnload: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(61.49), "compressor 629 LoadUnload: kW_Calc 2");
    ...
    testNumberValue(rnd(results.PerkW), rnd(101.42), "compressor 629 LoadUnload: PerkW 3");
    testNumberValue(rnd(results.kW_Calc), rnd(86.61), "compressor 629 LoadUnload: kW_Calc 3");
    ...
    testNumberValue(rnd(results.C_Per), rnd(91.23), "compressor 629 LoadUnload: C_Per 4");
    testNumberValue(rnd(results.kW_Calc), rnd(86.6), "compressor 629 LoadUnload: kW_Calc 4");
}
...
function compId629StartStop() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(35.96), "compressor 629 Start/Stop: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(30.71), "compressor 629 Start/Stop: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(34.99), "compressor 629 Start/Stop: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(30.7), "compressor 629 Start/Stop: kW_Calc 2");
}
...
function compId861LoadUnload() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(35.97), "compressor 861 Load/Unload: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(30.72), "compressor 861 Load/Unload: kW_Calc 1");
    ...
    // t.equal(rnd(results.powerCalculated), rnd(30.7));
    testNumberValue(rnd(results.C_Per), rnd(34.97), "compressor 861 Load/Unload: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(30.7), "compressor 861 Load/Unload: kW_Calc 2");
...
function compId861StartStop() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(66.52), "compressor 861 StartStop: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(34.13), "compressor 861 StartStop: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(64.95), "compressor 861 StartStop: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(34.1), "compressor 861 StartStop: kW_Calc 2");
}
...
function compId1156LoadUnload() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(24.61), "compressor 1156 LoadUnload: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(15.88), "compressor 1156 LoadUnload: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(9.86), "compressor 1156 LoadUnload: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(15.8), "compressor 1156 LoadUnload: kW_Calc 2");
    ...
    testNumberValue(rnd(results.PerkW), rnd(93.76), "compressor 1156 LoadUnload: PerkW 3");
    testNumberValue(rnd(results.kW_Calc), rnd(60.48), "compressor 1156 LoadUnload: kW_Calc 3");
    ...
    testNumberValue(rnd(results.C_Per), rnd(89.73), "compressor 1156 LoadUnload: C_Per 4");
    testNumberValue(rnd(results.kW_Calc), rnd(60.3), "compressor 1156 LoadUnload: kW_Calc 4");
}
...
function compId1156StartStop() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(35.84), "compressor 1156 StartStop: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(23.12), "compressor 1156 StartStop: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(34.82), "compressor 1156 StartStop: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(23), "compressor 1156 StartStop: kW_Calc 2");
}
...
function compId1187() {
    ...
    testNumberValue(rnd(results.PerkW), rnd(24.52), "compressor 1187: PerkW 1");
    testNumberValue(rnd(results.kW_Calc), rnd(26.16), "compressor 1187: kW_Calc 1");
    ...
    testNumberValue(rnd(results.C_Per), rnd(9.94), "compressor 1187: C_Per 2");
    testNumberValue(rnd(results.kW_Calc), rnd(26.12), "compressor 1187: kW_Calc 2");
    ...
    testNumberValue(rnd(results.PerkW), rnd(93.95), "compressor 1187: PerkW 3");
    testNumberValue(rnd(results.kW_Calc), rnd(100.24), "compressor 1187: kW_Calc 3");
    ...
    testNumberValue(rnd(results.C_Per), rnd(89.79), "compressor 1187: C_Per 4");
    testNumberValue(rnd(results.kW_Calc), rnd(99.99), "compressor 1187: kW_Calc 4");
}
