...
TEST_CASE("Calculate the Saturated Liquid Specific Enthalpy (Region 1)",
          "[Liquid Enthalpy][steamModeler][Calculator]") {
...
TEST_CASE("Calculate the Saturated Liquid Specific Enthalpy (Region 3)",
          "[Liquid Enthalpy][steamModeler][Calculator]") {
    SaturatedProperties sp    = SaturatedProperties(20.2659, 640);
    auto const          props = sp.calculate();
