...
auto validateSteamPropertiesAtPT = [](const double pressure, const double temperature,
...
TEST_CASE("Calculate Steam Properties using Pressure and Temperature", "[HeatCapacityCpCvIsentropicExponent]") {
    ...
    validateSteamPropertiesAtPT(0.0035, 700,
    ...
    validateSteamPropertiesAtPT(30, 700,
    ...
    validateSteamPropertiesAtPT(78.3095639, 750,
