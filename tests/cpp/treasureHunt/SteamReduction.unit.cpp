...
TEST_CASE("Steam Reduction Flow Meter Method", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {SteamReductionInput(
        8000, 1, 5.5, 0, 0.8, 3.5, SteamFlowMeterMethodData(1000),
        SteamMassFlowMethodData(false, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamOffsheetMethodData(13000000), 1, 0.75, SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15)};
...
TEST_CASE("Steam Reduction Air Mass Flow - Measured", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {SteamReductionInput(
        8000, 1, 5.5, 1, 0.8, 3.5, SteamFlowMeterMethodData(1000),
        SteamMassFlowMethodData(false, SteamMassFlowMeasuredData(1.0, 100.0), SteamMassFlowNameplateData(4000.0), 25.0,
                                425.0),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamOffsheetMethodData(13000000), 1, 0.75, SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15)};
...
TEST_CASE("Steam Reduction Air Mass Flow - Nameplate", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {SteamReductionInput(
        8000, 1, 5.5, 1, 0.8, 3.5, SteamFlowMeterMethodData(1000),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1.0, 100.0), SteamMassFlowNameplateData(4000.0), 25.0,
                                425.0),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamOffsheetMethodData(13000000), 1, 0.75, SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15)};
...
TEST_CASE("Steam Reduction Water Mass Flow - Nameplate", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {SteamReductionInput(
        8000, 1, 5.5, 2, 0.8, 3.5, SteamFlowMeterMethodData(1000),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(100.0, 5.0), SteamMassFlowNameplateData(400.0), 70.0,
                                200.0),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(1), 25.0, 225.0),
        SteamOffsheetMethodData(13000000), 1, 0.75, SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15)};
...
TEST_CASE("Steam Reduction Offsheet Method", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {SteamReductionInput(
        8000, 0, 5.5, 3, 0.8, 3.5, SteamFlowMeterMethodData(5000),
        SteamMassFlowMethodData(false, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100), SteamMassFlowNameplateData(40000.0), 25, 425),
        SteamOffsheetMethodData(13000000), 1, 0.75, SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15)};
...
TEST_CASE("Steam Reduction Multi Method", "[SteamReduction][Util]") {
    std::vector<SteamReductionInput> steamReductionInputVec = {
        // flow meter method
        SteamReductionInput(8000, 1, 5.5, 0, 0.8, 3.5, SteamFlowMeterMethodData(1000),
                            SteamMassFlowMethodData(false, SteamMassFlowMeasuredData(1, 100),
                                                    SteamMassFlowNameplateData(40000.0), 25, 425),
                            SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100),
                                                    SteamMassFlowNameplateData(40000.0), 25, 425),
                            SteamOffsheetMethodData(13000000), 1, 0.75,
                            SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15),
        // water mass
        SteamReductionInput(8000, 1, 5.5, 2, 0.8, 3.5, SteamFlowMeterMethodData(1000),
                            SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(100.0, 5.0),
                                                    SteamMassFlowNameplateData(400.0), 70.0, 200.0),
                            SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100),
                                                    SteamMassFlowNameplateData(1), 25.0, 225.0),
                            SteamOffsheetMethodData(13000000), 1, 0.75,
                            SteamProperties::ThermodynamicQuantity::TEMPERATURE, 560, 283.15),
        // Offsheet method
        SteamReductionInput(8000, 0, 5.5, 3, 0.8, 3.5, SteamFlowMeterMethodData(1000),
                            SteamMassFlowMethodData(false, SteamMassFlowMeasuredData(1, 100),
                                                    SteamMassFlowNameplateData(40000.0), 25, 425),
                            SteamMassFlowMethodData(true, SteamMassFlowMeasuredData(1, 100),
                                                    SteamMassFlowNameplateData(40000.0), 25, 425),
