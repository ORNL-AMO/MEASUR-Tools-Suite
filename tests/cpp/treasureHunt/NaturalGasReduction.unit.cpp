...
TEST_CASE("Natural Gas Reduction Flow Meter Method", "[NaturalGasReduction][Util]") {
    ...
    std::vector<NaturalGasReductionInput> naturalGasReductionInputVec = {NaturalGasReductionInput(
        8640, 0.12, 0, FlowMeterMethodData(5), NaturalGasOtherMethodData(200000),
        AirMassFlowData(true, AirMassFlowMeasuredData(50, 200), AirMassFlowNameplateData(10000), 120, 200, 100),
...
TEST_CASE("Natural Gas Reduction Air Mass Flow Nameplate", "[NaturalGasReduction][Util]") {
    std::vector<NaturalGasReductionInput> naturalGasReductionInputVec = {NaturalGasReductionInput(
        8640, 0.12, 1, FlowMeterMethodData(5), NaturalGasOtherMethodData(200000),
        AirMassFlowData(true, AirMassFlowMeasuredData(50, 200), AirMassFlowNameplateData(30), 120, 200, 1),
...
TEST_CASE("Natural Gas Reduction Air Mass Flow Measured", "[NaturalGasReduction][Util]") {
    std::vector<NaturalGasReductionInput> naturalGasReductionInputVec = {NaturalGasReductionInput(
        8640, 0.12, 1, FlowMeterMethodData(5), NaturalGasOtherMethodData(200000),
        AirMassFlowData(false, AirMassFlowMeasuredData(50, 200), AirMassFlowNameplateData(30), 120, 200, 1),
        WaterMassFlowData(400, 120, 200, 1), 2)};
...
TEST_CASE("Natural Gas Reduction Water Mass Flow", "[NaturalGasReduction][Util]") {
    std::vector<NaturalGasReductionInput> naturalGasReductionInputVec = {NaturalGasReductionInput(
        8640, 0.12, 2, FlowMeterMethodData(5), NaturalGasOtherMethodData(200000),
        AirMassFlowData(false, AirMassFlowMeasuredData(50, 200), AirMassFlowNameplateData(30), 120, 200, 1),
        WaterMassFlowData(400, 120, 200, 1), 2)};
...
TEST_CASE("Natural Gas Reduction Other/Off Sheet", "[NaturalGasReduction][Util]") {
    std::vector<NaturalGasReductionInput> naturalGasReductionInputVec = {NaturalGasReductionInput(
        8640, 0.12, 3, FlowMeterMethodData(5), NaturalGasOtherMethodData(2000),
        AirMassFlowData(false, AirMassFlowMeasuredData(50, 200), AirMassFlowNameplateData(30), 120, 200, 1),
        WaterMassFlowData(400, 120, 200, 1), 2)};
