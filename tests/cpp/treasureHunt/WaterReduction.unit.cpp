...
TEST_CASE("Water Reduction Metered Flow Data", "[WaterReduction][util]") {
    std::vector<WaterReductionInput> waterReductionInputVec = {
        WaterReductionInput(8640, 0.005, 0, MeteredFlowMethodData(100), VolumeMeterMethodData(5942, 4235, 15),
                            BucketMethodData(10, 20), WaterOtherMethodData(15000))};
...
TEST_CASE("Water Reduction VolumeMeterData", "[WaterReduction][util]") {
    std::vector<WaterReductionInput> waterReductionInputVec = {
        WaterReductionInput(8640, 0.005, 1, MeteredFlowMethodData(100), VolumeMeterMethodData(5942, 4235, 15),
                            BucketMethodData(10, 20), WaterOtherMethodData(15000))};
...
TEST_CASE("Water Reduction BucketMethodData", "[WaterReduction][util]") {
    std::vector<WaterReductionInput> waterReductionInputVec = {
        WaterReductionInput(8640, 0.005, 2, MeteredFlowMethodData(100), VolumeMeterMethodData(5942, 4235, 15),
                            BucketMethodData(10, 20), WaterOtherMethodData(15000))};
...
TEST_CASE("Water Reduction WaterOtherMethodData", "[WaterReduction][util]") {
    std::vector<WaterReductionInput> waterReductionInputVec = {
        WaterReductionInput(8640, 0.005, 3, MeteredFlowMethodData(100), VolumeMeterMethodData(5942, 4235, 15),
                            BucketMethodData(10, 20), WaterOtherMethodData(15000))};
