...
TEST_CASE("Insulated Tank", "[InsulatedTankReduction][util]") {
    ...
    InsulatedTankInput input(operatingHours, tankHeight, tankDiameter, tankThickness, tankEmissivity, tankConductivity,
                             tankTemperature, ambientTemperature, systemEfficiency, insulationThickness,
                             insulationConductivity, jacketEmissivity, surfaceTemperature);

    InsulatedTankReduction calculator(input);
