...
TEST_CASE("Compressed Air Reduction Flow Meter Method", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 0, 0.12, 0, CompressedAirFlowMeterMethodData(200), BagMethod(8640, 30, 1.36, 1),
        PressureMethodData(0, 1, 80), CompressedAirOtherMethodData(200000), CompressorElectricityData(1.428, 1.38233),
        1)};
...
TEST_CASE("Compressed Air Reduction Flow Meter Method and Electricity", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 1, 0.12, 0, CompressedAirFlowMeterMethodData(200000), BagMethod(8640, 30, 1.36, 1),
        PressureMethodData(0, 1, 80), CompressedAirOtherMethodData(200000), CompressorElectricityData(0.8, 0.16), 1)};
...
TEST_CASE("Compressed Air Reduction Bag Method and Electricity", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 1, 0.12, 1, CompressedAirFlowMeterMethodData(200000), BagMethod(8640, 12, 8.68, 2),
        PressureMethodData(0, 1, 80), CompressedAirOtherMethodData(200000), CompressorElectricityData(0.40, 0.16), 2)};
...
TEST_CASE("Compressed Air Reduction Orifice Pressure Method and Electricity", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 1, 0.12, 2, CompressedAirFlowMeterMethodData(200000), BagMethod(8640, 12, 8.68, 2),
        PressureMethodData(0, 1, 80), CompressedAirOtherMethodData(200000), CompressorElectricityData(0.40, 0.16), 1)};
...
TEST_CASE("Compressed Air Reduction Orifice Pressure Method Multiple Nozzles", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 1, 0.12, 2, CompressedAirFlowMeterMethodData(200000), BagMethod(8640, 12, 8.68, 2),
        PressureMethodData(2, 4, 50), CompressedAirOtherMethodData(200000), CompressorElectricityData(0.40, 0.16), 3)};
...
TEST_CASE("Compressed Air Reduction Other Method", "[CompressedAirReduction][Util]") {
    std::vector<CompressedAirReductionInput> compressedAirReductionInputVec = {CompressedAirReductionInput(
        8640, 1, 0.12, 3, CompressedAirFlowMeterMethodData(200000), BagMethod(8640, 12, 8.68, 2),
        PressureMethodData(2, 4, 50), CompressedAirOtherMethodData(200000), CompressorElectricityData(0.40, 0.16), 1)};
