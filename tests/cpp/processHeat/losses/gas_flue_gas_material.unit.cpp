...
TEST_CASE("Calculate Heat Loss for flue gas Losses", "[Heat Loss]") {
    ...
    CHECK(composition.getProcessHeatProperties(700, 0.0231722095, 125, 125, 60, 0).availableHeat ==
          Approx(0.7831351536));
    CHECK(composition.getProcessHeatProperties(700, 0.1552234415, 125, 125, 60, 0).availableHeat ==
          Approx(0.5615301965));
