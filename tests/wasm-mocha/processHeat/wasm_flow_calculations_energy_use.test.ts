...
describe('Process Heat Flow Calculations Energy Use', function () {
    ...
    it('should calculate flowCalculationsEnergyUse results correctly 1', function () {
        const results = moduleInstance.flowCalculationsEnergyUse(0.14, 5, 9, 0.6, 7325, 52, 63, 26, 16);
    ...
    it('should calculate flowCalculationsEnergyUse results correctly 2', function () {
        const results = moduleInstance.flowCalculationsEnergyUse(1, 3.5, 8, 0.6, 0, 85, 20, 10, 10);
    ...
    it('should calculate flowCalculationsEnergyUse results correctly 3', function () {
        const results = moduleInstance.flowCalculationsEnergyUse(7, 6, 18, 0.8, 60000, 85, 55, 20, 10);
    ...
    it('should calculate flowCalculationsEnergyUse results correctly 4', function () {
        const results = moduleInstance.flowCalculationsEnergyUse(1, 3.5, 8, 0.8, 0, 85, 20, 10, 10);
