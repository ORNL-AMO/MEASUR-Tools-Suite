...
describe('Process Heat SolidLiquidFlueGasMaterial', function () {
    ...
    it('should calculate heatingValue correctly', function () {
        ...
        var heatingValue = moduleInstance.calculateHeatingValueFuel(inp.carbon, inp.hydrogen, inp.sulphur, inp.inertAsh, inp.o2, inp.moisture, inp.nitrogen);
    ...
    it('should calculate flueGasO2 correctly 1', function () {
        ...
        var flueGasO2 = moduleInstance.calculateFlueGasO2(inp.excessAir, inp.carbon, inp.hydrogen, inp.sulphur, inp.inertAsh, inp.o2, inp.moisture, inp.nitrogen, inp.moistureInAirCombustion) * 100;
