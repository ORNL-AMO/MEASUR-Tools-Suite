...
describe('Process Heat SolidLiquidFlueGasMaterial', function () {
    ...
    it('should calculate heatLoss correctly', function () {
        ...
        var flueGasLossesByMass = new moduleInstance.SolidLiquidFlueGasMaterial(inp.flueGasTemperature, inp.excessAirPercentage, inp.combustionAirTemperature,
    ...
    it('should calculate heatingValue correctly', function () {
        ...
        var solidLiquidFlueGasMaterial = new moduleInstance.SolidLiquidFlueGasMaterial();
