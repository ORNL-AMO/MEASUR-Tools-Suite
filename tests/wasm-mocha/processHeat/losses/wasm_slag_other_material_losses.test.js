...
describe('Process Heat SlagOtherMaterialLosses', function () {
    ...
    it('should calculate heatLoss correctly 1', function () {
        ...
        var slagOtherMaterialLosses = new moduleInstance.SlagOtherMaterialLosses(inp.weight, inp.inletTemperature, inp.outletTemperature, inp.specificHeat, inp.correctionFactor);
