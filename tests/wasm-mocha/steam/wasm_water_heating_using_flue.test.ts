...
import createModule, { type MeasurToolsSuite, type WaterHeatingUsingFlueOutput } from 'measur-tools-suite';
...
describe('Steam water heating using flue', function () {
    ...
    it('should calculate waterHeatingUsingFlue results correctly', function () {
        ...
        try {
            const results: WaterHeatingUsingFlueOutput = moduleInstance.waterHeatingUsingFlue(gasInstance, 725, 0.05, 80, 0.02, 55.88, 3.45, 60, 500,
