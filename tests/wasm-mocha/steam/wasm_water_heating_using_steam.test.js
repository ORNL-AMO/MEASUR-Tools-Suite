...
describe('Steam water heating using steam', function () {
    ...
    it('should calculate waterHeatingUsingSteam results correctly 1', function () {
        let results = moduleInstance.waterHeatingUsingSteam(0.1565, 340.2, 285.93, 0.5150, 2.7255, 285.93, 0.2048, 0.72, 0.8, 7000);
    ...
    it('should calculate waterHeatingUsingSteam results correctly 2', function () {
        let results = moduleInstance.waterHeatingUsingSteam(0.1703, 226.79, 285.93, 0.2737, 0.6814, 285.93, 0.2048, 0.7, 0.7, 8000);
