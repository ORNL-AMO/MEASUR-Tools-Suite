...
import createModule, {
    ...
    type PneumaticAirRequirementDoubleActingInput,
    type PneumaticAirRequirementResult,
    type PneumaticAirRequirementSingleActingInput,
...
describe('Compressed Air Pneumatic Air Requirement', function () {
    ...
    it('should calculate air requirement for a single-acting piston (1.5 in bore, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementSingleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 6, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementSingleActing(inp);
    ...
    it('should calculate air requirement for a single-acting piston (3.5 in bore, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementSingleActingInput = { cylinderDiameter: 3.5, cylinderStroke: 6, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementSingleActing(inp);
    ...
    it('should calculate air requirement for a single-acting piston (9 in stroke, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementSingleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 9, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementSingleActing(inp);
    ...
    it('should calculate air requirement for a single-acting piston (140 psi, 90 cpm)', function () {
        const inp: PneumaticAirRequirementSingleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 6, airPressure: 140, cyclesPerMin: 90 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementSingleActing(inp);
        assert.approximately(result.volumeAirIntakePiston,           0.55223, 0.001);
    ...
    it('should calculate air requirement for a double-acting piston (1.5 in bore, 0.375 in rod, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementDoubleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 6, pistonRodDiameter: 0.375, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementDoubleActing(inp);
    ...
    it('should calculate air requirement for a double-acting piston (3.5 in bore, 0.375 in rod, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementDoubleActingInput = { cylinderDiameter: 3.5, cylinderStroke: 6, pistonRodDiameter: 0.375, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementDoubleActing(inp);
    ...
    it('should calculate air requirement for a double-acting piston (9 in stroke, 0.375 in rod, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementDoubleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 9, pistonRodDiameter: 0.375, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementDoubleActing(inp);
    ...
    it('should calculate air requirement for a double-acting piston (0.575 in rod, 100 psi, 60 cpm)', function () {
        const inp: PneumaticAirRequirementDoubleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 6, pistonRodDiameter: 0.575, airPressure: 100, cyclesPerMin: 60 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementDoubleActing(inp);
    ...
    it('should calculate air requirement for a double-acting piston (0.575 in rod, 140 psi, 90 cpm)', function () {
        const inp: PneumaticAirRequirementDoubleActingInput = { cylinderDiameter: 1.5, cylinderStroke: 6, pistonRodDiameter: 0.575, airPressure: 140, cyclesPerMin: 90 };
        const result: PneumaticAirRequirementResult = moduleInstance.calculatePneumaticAirRequirementDoubleActing(inp);
