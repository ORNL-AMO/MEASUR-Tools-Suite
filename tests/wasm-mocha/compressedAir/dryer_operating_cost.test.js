    ...
    it('calculates Dryer Operating Cost', function () {
        ...
        try {
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.Heatless),
                {waterRemoved:73.34, totalCostPerYear: 60020.86, heaterPower: 0, heatingHoursPerDay: 0, purgeRate: 15, designDDCPercentage: 16.3299});
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.HeatedExternally),
                {waterRemoved:73.34, totalCostPerYear: 38193.08, heaterPower: 19.358, heatingHoursPerDay: 18, purgeRate: 7, designDDCPercentage: 16.3299});
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.BlowerPurgeWithSweep),
                {waterRemoved:73.34, totalCostPerYear: 51442.40, heaterPower: 69.136, heatingHoursPerDay: 18, purgeRate: 7, designDDCPercentage: 16.3299});
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.BlowerPurgeWithoutSweep),
                {waterRemoved:73.34, totalCostPerYear: 47161.58, heaterPower: 69.136, heatingHoursPerDay: 18, purgeRate: 7, designDDCPercentage: 16.3299});
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.HeatOfCompressionHC),
                {waterRemoved:73.34, totalCostPerYear: 3333.81, heaterPower: 3.0489, heatingHoursPerDay: 3, purgeRate: 2, designDDCPercentage: 16.3299});
            ...
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.HeatOfCompressionSP),
                {waterRemoved:73.34, totalCostPerYear: 69.888, heaterPower: 0, heatingHoursPerDay: 0, purgeRate: 0, designDDCPercentage: 16.3299});

            logMessage('Dryer Type Refrigerated: ');
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.Refrigerated),
                {waterRemoved:63.944, totalCostPerYear: 8639.09, heaterPower: 0, heatingHoursPerDay: 0, purgeRate: 0, designDDCPercentage: 16.3299});
        } finally {
        ...
        try {
            ...
            dryerOperatingCost = new moduleInstance.DryerOperatingCost(1752, 50, 100,
                ...
                3.05, 0, 0, 0);
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.HeatOfCompressionHC),
                {waterRemoved:73.34, totalCostPerYear: 3333.81, heaterPower: 3.05, heatingHoursPerDay: 3, purgeRate: 2, designDDCPercentage: 16.3299});
        } finally {
            dryerOperatingCost.delete();
        }
        ...
        try {
            ...
            dryerOperatingCost = new moduleInstance.DryerOperatingCost(1752, 50, 100,
                ...
                0, 0, 0, 16.33);
            validateDryerOutput(dryerOperatingCost.calculate(moduleInstance.DryerType.HeatOfCompressionHC),
                {waterRemoved:73.34, totalCostPerYear: 3333.81, heaterPower: 3.0501, heatingHoursPerDay: 3, purgeRate: 2, designDDCPercentage: 16.33});
        } finally {
            dryerOperatingCost.delete();
        }
