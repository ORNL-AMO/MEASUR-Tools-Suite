...
describe('Compressed Air Pipe Sizing', function () {
    ...
    it('should calculate cross-sectional area and diameter (1000 cfm, 90 psig, 25 ft/s)', function () {
        const inp: PipeSizingInput = { airflow: 1000, airlinePressure: 90, designVelocity: 25, atmosphericPressure: 14.5 };
        const result: PipeSizingResult = moduleInstance.calculatePipeSize(inp);
    ...
    it('should calculate cross-sectional area and diameter (1400 cfm, 90 psig, 25 ft/s)', function () {
        const inp: PipeSizingInput = { airflow: 1400, airlinePressure: 90, designVelocity: 25, atmosphericPressure: 14.5 };
        const result: PipeSizingResult = moduleInstance.calculatePipeSize(inp);
    ...
    it('should calculate cross-sectional area and diameter (1400 cfm, 110 psig, 25 ft/s)', function () {
        const inp: PipeSizingInput = { airflow: 1400, airlinePressure: 110, designVelocity: 25, atmosphericPressure: 14.5 };
        const result: PipeSizingResult = moduleInstance.calculatePipeSize(inp);
    ...
    it('should calculate cross-sectional area and diameter (1400 cfm, 110 psig, 30 ft/s)', function () {
        const inp: PipeSizingInput = { airflow: 1400, airlinePressure: 110, designVelocity: 30, atmosphericPressure: 14.5 };
        const result: PipeSizingResult = moduleInstance.calculatePipeSize(inp);
    ...
    it('should calculate cross-sectional area and diameter (1400 cfm, 110 psig, 30 ft/s, 11.5 psia)', function () {
        const inp: PipeSizingInput = { airflow: 1400, airlinePressure: 110, designVelocity: 30, atmosphericPressure: 11.5 };
        const result: PipeSizingResult = moduleInstance.calculatePipeSize(inp);
